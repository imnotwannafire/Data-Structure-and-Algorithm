// Tren 1 ban co vua NxN. Tren ban co se co o trong (=0) va co vat can (=1).
// Quan xe di chuyen vao cac o trong, khong di duoc vao cac o co vat can theo duong ngang va doc
...
// so luong cac di chuyen cua quan tinh la 4 o duong ngang, doc
//
int dx[4] = {-1, 0,0, 1};
int dy[4] = {0,-1,1,0};
